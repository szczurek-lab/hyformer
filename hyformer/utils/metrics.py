...
def calculate_metric(
    ...
    metric: str,
    prediction_task_type: str = 'predictive',
    **kwargs
    ...
    Args:
        ...
        prediction_task_type: Type of task ('generative' or 'predictive')
    ...
    if prediction_task_type == 'generative':
    ...
    elif prediction_task_type == 'predictive':
        if metric == 'rmse':
        ...
        raise ValueError(f"Task type {prediction_task_type} not supported")
