...
class CSVStorage(DataStorage):
    ...
    --------
    >>> import pandas as pd
    >>> from hyformer.utils.datasets.storage.csv_storage import CSVStorage
    >>> 
    ...
    def __init__(self, dataframe: pd.DataFrame, column_mapping: Optional[Dict[str, str]] = None):
    ...
    @classmethod
    def from_path(cls, path: str, column_mapping: Optional[Dict[str, str]] = None, **kwargs) -> 'CSVStorage':
