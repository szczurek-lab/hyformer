...
class AutoTokenizer:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, local_dir=None):
        ...
        # download vocabulary
        vocab_absolute_path = hf_hub_download(
        ...
        _tokenizer_config.path_to_vocabulary = vocab_absolute_path  # overwrite path_to_vocabulary with vocab_absolute_path
