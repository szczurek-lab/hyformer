...
class PredictionHead(nn.Module):
    ...
    def __init__(self, embedding_dim: int, num_prediction_tasks: int, dropout_p: float, activation_fn: str = 'gelu') -> None:
        super().__init__()
        ...
        self.out_proj = nn.Linear(embedding_dim, num_prediction_tasks)
